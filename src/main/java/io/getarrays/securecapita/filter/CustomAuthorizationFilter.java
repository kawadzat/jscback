...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    private static final String[] PUBLIC_ROUTES = {"/user/login", "/user/verify/code", "/user/register","/user/**", "/purchaseRequisition/upload","/store/**","stock/all","stock/delete/**","stock/check/**", "/user/refresh/token", "/user/image"};
