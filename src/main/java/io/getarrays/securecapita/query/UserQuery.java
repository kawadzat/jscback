...
public class UserQuery {
    ...
    public static final String UPDATE_USER_PASSWORD_BY_URL_QUERY = "UPDATE Users SET password = :password, password_last_changed = :passwordLastChanged WHERE id = (SELECT user_id FROM ResetPasswordVerifications WHERE url = :url)";
    ...
    public static final String UPDATE_USER_PASSWORD_BY_ID_QUERY = "UPDATE Users SET password = :password, password_last_changed = :passwordLastChanged WHERE id = :userId";
